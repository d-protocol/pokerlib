...
type Game interface {
	Start() error
	GetState() *pokerlib.GameState
	OnStateUpdated(func(*pokerlib.GameState))
...
func NewGame(backend Backend, opts *pokerlib.GameOptions) *game {
...
func (g *game) handleState(gs *pokerlib.GameState) {
...
func (g *game) OnStateUpdated(fn func(*pokerlib.GameState)) {
	g.onStateUpdated = fn
}
...
func (g *game) GetState() *pokerlib.GameState {
	return g.gs
}
