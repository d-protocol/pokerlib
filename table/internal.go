...
func (t *table) updateGameState(gs *pokerlib.GameState) error {
...
func (t *table) startGame() error {
	...
	for i, s := range seats {
		...
		opts.Players = append(opts.Players, &pokerlib.PlayerSetting{
	...
	t.g.OnStateUpdated(func(gs *pokerlib.GameState) {
